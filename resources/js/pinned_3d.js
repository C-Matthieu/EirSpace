...
(function () {
    ...
    /* =============================================================
       ASTRO — orbiting starfield with constellations
       ============================================================= */
    function buildAstroScene(scene) {
        ...
        var core = new THREE.Mesh(
            ...
            new THREE.MeshBasicMaterial({ color: 0x4d9de0, transparent: true, opacity: 0.12 })
        );
        var coreInner = new THREE.Mesh(
            new THREE.SphereGeometry(1.4, 32, 32),
            new THREE.MeshBasicMaterial({ color: 0xb388ff, transparent: true, opacity: 0.2 })
        );
        ...
        return { points: points, core: core, coreInner: coreInner };
    }
    ...
    function initPinned(stage, type) {
        ...
        function tick() {
            ...
            if (type === 'rocket') {
                ...
                astro.core.scale.setScalar(1 + Math.sin(now * 0.0015) * 0.06);
                astro.coreInner.scale.setScalar(1 + Math.cos(now * 0.0012) * 0.08);
            }
